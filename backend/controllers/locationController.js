...
const saveLocation = async (req, res) => {
    const { country, countryCode, city, serverId } = req.body;
    try {
        const user = await User.findById(req.user.id);
        user.lastLocation = { country, countryCode, city, serverId };
        await user.save();
...
module.exports = { fetchCountries, fetchStates, fetchCities, saveLocation, getLastLocation };
